...
DemographicData <- demographics %>% group_by_at(vars(Gender,AgeGroup,Race,Count))
...
Let us look at the overall arrest count over time.
...
Let's see if any related events coincided with changes in arrests. 
