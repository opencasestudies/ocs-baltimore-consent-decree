...
To finish exploring the relationship between explanatory variables and our outcome, we'll examine arrest counts and rates by weekday. **Michael**: add something here. 
...
**Michael**: Insert a sentence here to transition to the next step and explain what you are doing below. 
...
**Michael**: Describe the process of model production and AIC calculation. 
